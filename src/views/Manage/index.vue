<template>
  <main>
    ...
    <div class="form" style="width: 1300px">
      ...
      <div class="form_main">
        <el-table
          ...
          border
          style="width: 1260px; margin: 3px 0"
        >
          ...
          <el-table-column label="操作" width="300">
            <template #default="scope">
              ...
              <el-button
                ...
                type="primary"
                class="table-btn"
                @click="addGoodsRecord(scope.$index)"
              >
                增加货物 </el-button
              ><el-button
                text
    ...
    <!-- 查看详情 -->
    <el-dialog
      v-model="centerDialogVisibledetail"
      title="查看商品详情"
      width="850"
      center="true"
      align-center
    >
      <el-descriptions title=" " border>
        <el-descriptions-item :rowspan="3" :width="100" label="商品图片">
          <el-image style="width: auto; height: 100px" :src="imageUrlUrl" />
